...
ARGS{1}{12} = coder.typeof(single(0),[N+nSpikeGenCells 1],'Gpu',true); % p0
...
ARGS{1}{22} = coder.typeof(false,[N+nSpikeGenCells   1],'Gpu',true); % ecells
ARGS{1}{23} = coder.typeof(false,[N+nSpikeGenCells   1],'Gpu',true); % icells
if (nSpikeGenCells > 0)
...
ARGS{1}{26} = coder.typeof(false,[N N+nSpikeGenCells],'Gpu',true); % is_plastic logical matrix
