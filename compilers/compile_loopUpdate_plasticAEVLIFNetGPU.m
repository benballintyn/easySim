...
ARGS{1}{36} = coder.typeof(single(0),[N 1],'Gpu',true); % o1
ARGS{1}{37} = coder.typeof(single(0),[N 1],'Gpu',true); % o2
ARGS{1}{38} = coder.typeof(single(0),[N+nSpikeGenCells 1],'Gpu',true); % A2plus
ARGS{1}{39} = coder.typeof(single(0),[N+nSpikeGenCells 1],'Gpu',true); % A3plus
ARGS{1}{40} = coder.typeof(single(0),[N 1],'Gpu',true); % A2minus
ARGS{1}{41} = coder.typeof(single(0),[N 1],'Gpu',true); % A3minus
ARGS{1}{42} = coder.typeof(single(0),[N+nSpikeGenCells 1],'Gpu',true); % tau_plus
ARGS{1}{43} = coder.typeof(single(0),[N+nSpikeGenCells 1],'Gpu',true); % tau_x
ARGS{1}{44} = coder.typeof(single(0),[N 1],'Gpu',true); % tau_minus
ARGS{1}{45} = coder.typeof(single(0),[N 1],'Gpu',true); % tau_y
