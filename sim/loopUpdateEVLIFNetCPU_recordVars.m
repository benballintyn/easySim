function [vRecord,vthRecord,iappRecord] = loopUpdateEVLIFNetCPU_recordVars(V,Vreset,tau_ref,Vth,Vth0,Vth_max,VsynE,VsynI,GsynE,GsynI,...
...
for i=1:nT
    ...
    iappRecord(:,i) = curIapp; % record input currents
