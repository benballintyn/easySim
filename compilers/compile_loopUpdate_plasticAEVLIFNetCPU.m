...
ARGS{1}{31} = coder.typeof(false,[maxN maxN+maxSpikeGen],[true true]); % is_plastic logical matrix
ARGS{1}{32} = coder.typeof('string',[1 20],[false true]); % plasticity_type string
ARGS{1}{33} = coder.typeof(false,[maxN maxN+maxSpikeGen],[true true]); % Connectivity matrix
ARGS{1}{34} = coder.typeof(0,[maxN+maxSpikeGen 1],[true false]); % r1
ARGS{1}{35} = coder.typeof(0,[maxN+maxSpikeGen 1],[true false]); % r2
ARGS{1}{36} = coder.typeof(0,[maxN 1],[true false]); % o1
ARGS{1}{37} = coder.typeof(0,[maxN 1],[true false]); % o2
ARGS{1}{38} = coder.typeof(0,[maxN+maxSpikeGen 1],[true false]); % A2plus
ARGS{1}{39} = coder.typeof(0,[maxN+maxSpikeGen 1],[true false]); % A3plus
ARGS{1}{40} = coder.typeof(0,[maxN 1],[true false]); % A2minus
ARGS{1}{41} = coder.typeof(0,[maxN 1],[true false]); % A3minus
ARGS{1}{42} = coder.typeof(0,[maxN+maxSpikeGen 1],[true false]); % tau_plus
ARGS{1}{43} = coder.typeof(0,[maxN+maxSpikeGen 1],[true false]); % tau_x
ARGS{1}{44} = coder.typeof(0,[maxN 1],[true false]); % tau_minus
ARGS{1}{45} = coder.typeof(0,[maxN 1],[true false]); % tau_y
ARGS{1}{46} = coder.typeof(0); % nT (# of timesteps to simulate)
ARGS{1}{47} = coder.typeof(0); % file ID for spikes
