...
% simulation functions (e.g. loopUpdateAEVLIFNetGPU_fast)
% setupAEVLIFNet(net,useGpu)
%   INPUTS:
%       net     - network object (e.g. AEVLIFnetwork)
%
...
if (net.is_plastic)
    error('The input network has plastic synapses but this setup function does not support plasticity. Use setup_plasticAEVLIFNet instead.')
end
