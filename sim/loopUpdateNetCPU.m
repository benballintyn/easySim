function [allVs,allSpikes] = loopUpdateNetCPU(V,Gref,dGref,tau_ref,Vth,VsynE,VsynI,GsynE,GsynI,maxGsynE,maxGsynI,...
...
allVs = zeros(size(V,1),nT);
allSpikes = zeros(size(V,1),nT);
for i=1:nT
    spiked = (V > Vth);
